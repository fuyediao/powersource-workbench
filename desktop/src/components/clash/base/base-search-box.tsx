...
import {
  ClashMatchCaseIcon,
  ClashMatchWholeWordIcon,
  ClashRegexIcon,
} from '@/icons/AllIcons'
import { buildRegex, compileStringMatcher } from '@/utils/clash/search-matcher'
            ...
            endAdornment: (
              <Box sx={{ display: 'flex' }}>
                ...
                <Tooltip title={t('shared.placeholders.matchWholeWord')}>
                  <SvgIcon
                    component={ClashMatchWholeWordIcon}
                    {...iconStyle}
