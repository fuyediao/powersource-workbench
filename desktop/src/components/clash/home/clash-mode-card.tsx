...
import { useClashMode, useRuntimeConfig } from '@/hooks/clash/use-clash'
...
import { patchClashMode } from '@/services/clash/cmds'
import { showNotice } from '@/services/clash/notice-service'
import { setCacheData } from '@/services/clash/query-client'
