...
import { DialogRef, Switch, TooltipIcon } from '@/components/clash/base'
...
import { useServiceUninstaller } from '@/hooks/clash/use-service-uninstaller'
import { useSystemProxyState } from '@/hooks/clash/use-system-proxy-state'
...
import { requestService } from '@/services/clash/service-request'
