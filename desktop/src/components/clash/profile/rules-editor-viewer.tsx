...
import {
  ...
  Switch,
  VirtualList,
} from '@/components/clash/base'
import { RuleItem } from '@/components/clash/profile/rule-item'
import { readProfileFile, saveProfileFile } from '@/services/clash/cmds'
...
import type { MonacoEditorInstance } from '@/types/clash/monaco'
import { clashEditorFontFamily } from '@/utils/clash/font-family'
import getSystem from '@/utils/clash/get-system'
import { isValidIpCidr } from '@/utils/clash/network'
import { parseYamlSafe } from '@/utils/clash/yaml'
        ...
        {visualization ? (
          ...
          <MonacoEditor
            ...
            options={{
              ...
              fontFamily: clashEditorFontFamily,
