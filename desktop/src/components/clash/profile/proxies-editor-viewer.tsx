...
import { BaseSearchBox, MonacoEditor, VirtualList } from '@/components/clash/base'
import { ProxyItem } from '@/components/clash/profile/proxy-item'
...
import parseUri from '@/utils/clash/uri-parser'
