...
import { BaseDialog, Switch } from '@/components/clash/base'
import { useProfiles } from '@/hooks/clash/use-profiles'
import { createProfile, patchProfile } from '@/services/clash/cmds'
import { showNotice } from '@/services/clash/notice-service'
import { version } from '@/constants/clash-app-version'
