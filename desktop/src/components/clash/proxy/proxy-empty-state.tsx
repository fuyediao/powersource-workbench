...
import { useAppRefreshers } from '@/providers/clash/app-data-context'
import { openLogsDir, restartCore } from '@/services/clash/cmds'
import { showNotice } from '@/services/clash/notice-service'
import { revalidateQuery } from '@/services/clash/query-client'
