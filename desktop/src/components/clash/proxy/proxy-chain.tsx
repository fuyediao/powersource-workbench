...
import { TooltipIcon } from '@/components/clash/base'
import { useRuntimeConfig } from '@/hooks/clash/use-clash'
import { useRecordSelection } from '@/hooks/clash/use-record-selection'
import { useAppRefreshers, useProxiesData } from '@/providers/clash/app-data-context'
import { updateProxyChainConfigInRuntime } from '@/services/clash/cmds'
import {
