...
/**
 * Mounts Clash's own (MUI-styled) dialogs inside GeoCRM Settings.
 *
 ...
 * the settings-to-GeoCRM plan explicitly scopes out of the pixel-for-pixel Tailwind
 ...
 * GeoCRM's unrelated keys. Dialogs stay closed until opened, so the host keeps
