...
import { ProfileMore } from '@/components/clash/profile/profile-more'
import {
  ProfileViewer,
  type ProfileViewerRef,
} from '@/components/clash/profile/profile-viewer'
import { SortableProfileItem } from '@/components/clash/profile/sortable-profile-item'
import { ConfigViewer } from '@/components/clash/setting/mods/config-viewer'
import { useListen } from '@/hooks/clash/use-listen'
...
import { errorDetail, showNotice } from '@/services/clash/notice-service'
import {
  fetchCacheData,
  revalidateQueries,
  useQuery,
} from '@/services/clash/query-client'
import {
  useLoadingCache,
  useSetLoadingCache,
  useThemeMode,
