...
export function useApplicationMenu(options: UseApplicationMenuOptions): void {
  ...
  useEffect(() => {
    const labels: ApplicationMenuLabels = {
      ...
      messages: t(FEATURE_TAB_LABEL_KEY.messages),
      mail: t(FEATURE_TAB_LABEL_KEY.mail),
      calendar: t(FEATURE_TAB_LABEL_KEY.calendar),
      kanban: t(FEATURE_TAB_LABEL_KEY.kanban),
      map: t(FEATURE_TAB_LABEL_KEY.map),
      admin: t(FEATURE_TAB_LABEL_KEY.admin),
      orders: t(FEATURE_TAB_LABEL_KEY.orders),
      products: t(FEATURE_TAB_LABEL_KEY.products),
      nexdot: t(FEATURE_TAB_LABEL_KEY.nexdot),
      teAdmin: t(FEATURE_TAB_LABEL_KEY.teAdmin),
      team: t(FEATURE_TAB_LABEL_KEY.team),
      ...
      clash: t(FEATURE_TAB_LABEL_KEY.clash),
