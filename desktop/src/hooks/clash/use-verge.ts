...
import { getVergeConfig, patchVergeConfig } from '@/services/clash/cmds'
import { getPreloadConfig, setPreloadConfig } from '@/services/clash/preload'
import { getCacheData, setCacheData, useQuery } from '@/services/clash/query-client'
