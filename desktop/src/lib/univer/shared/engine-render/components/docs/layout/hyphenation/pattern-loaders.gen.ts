/**
 * Workbench substitute for upstream Univer's build-time-generated `pattern-loaders.gen.ts`.
 *
 ...
 * bring it along. Workbench regenerates the same shape with Vite's native
