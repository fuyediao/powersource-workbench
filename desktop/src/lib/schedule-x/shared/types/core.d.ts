...
declare const getTimePointsPerPixel: ($app: CalendarAppSingleton) => number;
declare const getTimeGridDayWidth: ($app: CalendarAppSingleton) => number;
declare const getTimeGridEventCopyElementId: (id: EventId) => string;
declare const getEventCoordinates: (uiEvent: UIEvent) => EventCoordinates;
declare const concatenatePeople: (people: string[]) => string;
declare const getLocalizedDate: (dateTime: Temporal.ZonedDateTime | Temporal.PlainDate, locale: string) => string;
...
declare const getDayNameShort: (date: Temporal.ZonedDateTime | Temporal.PlainDate, locale: string) => string;
declare const isToday: (date: Temporal.ZonedDateTime | Temporal.PlainDate, timezone: IANATimezone) => boolean;
/**
...
declare const toIntegers: (dateTimeSpecification: string) => DateTimeVariables;
declare const dateFromDateTime: (dateTime: string) => string;
declare const timeFromDateTime: (dateTime: string) => string;
declare const setDateInDateTime: (dateTime: Temporal.ZonedDateTime, newDate: Temporal.ZonedDateTime) => Temporal.ZonedDateTime;
declare const calculateDaysDifference: (startDate: Temporal.ZonedDateTime | Temporal.PlainDate, endDate: Temporal.ZonedDateTime | Temporal.PlainDate) => number;
// 100 / 60
declare const timePointsFromString: (timeString: string) => number;
declare const timeStringFromTimePoints: (timePoints: number) => string;
declare const addTimePointsToDateTime: (dateTime: Temporal.ZonedDateTime, pointsToAdd: number) => Temporal.ZonedDateTime;
declare const timePointToPercentage: (timePointsInDay: number, dayBoundaries: DayBoundariesInternal, timePoint: number) => number;
declare const getYCoordinateInTimeGrid: (dateTime: Temporal.ZonedDateTime, dayBoundaries: DayBoundariesInternal, pointsPerDay: number) => number;
...
export { definePlugin, deepCloneEvent, getTimePointsPerPixel, getTimeGridDayWidth, getTimeGridEventCopyElementId, getEventCoordinates, concatenatePeople, getTimeStamp, getLocalizedDate, getDayNameShort, isToday, TimeIcon, UserIcon, DescriptionIcon, LocationPinIcon, randomStringId, toTimeString, toDateTimeString, dateStringRegex, toDateString, toJSDate, toIntegers, dateFromDateTime, timeFromDateTime, addDays, addMonths, __deprecated__addMinutes as addMinutes, setDateInDateTime, calculateDaysDifference, timeStringFromTimePoints, addTimePointsToDateTime, timePointsFromString, timePointToPercentage, getYCoordinateInTimeGrid, PluginName, AppContext, createPreactView };
export type { CalendarConfigExternal, ResourceGridOptions, CalendarConfigInternal, CalendarEventExternal as CalendarEvent, EventModalPlugin, CalendarEventInternal, TimezoneSelectPlugin, View, ViewConfig, CalendarAppSingleton, PluginBase, CalendarState, CalendarEvents, DragAndDropPlugin, TimeGridDragHandler, DateGridDragHandler, MonthGridDragHandler, DragHandlerDependencies, ResizePlugin, EventCoordinates, CustomComponentFns as CustomComponents, CustomComponentName, DateRange, Resource, BackgroundEvent, DayBoundariesDateTime, DayBoundariesInternal, RangeSetterConfig, PreactViewComponent };
