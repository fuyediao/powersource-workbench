...
import { RefreshersContext, useAppRefreshers } from './app-data-context'
...
test('AppDataProvider children can call useAppRefreshers', () => {
  function Probe() {
    const { refreshAll } = useAppRefreshers()
    return <span>{typeof refreshAll}</span>
  }
