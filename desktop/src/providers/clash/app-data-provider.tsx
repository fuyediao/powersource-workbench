...
import { runStateQueryKey } from '@/hooks/clash/use-system-state'
...
import { revalidateQueries, useQuery } from '@/services/clash/query-client'
...
/**
 * Supplies Clash Home / proxy / rules data and refreshers to the island tree.
 * @param props - React children that may call `useAppRefreshers` and related hooks.
...
export const AppDataProvider = ({
  ...
  // Query the same keys as `use-clash.ts` without importing that module: a
  // circular chunk graph was duplicating `app-data-context` in production.
