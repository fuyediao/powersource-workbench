...
- Added curated SQL for profiles, history, groups, leftover customers, Mail, and Calendar. Deploy applies those migrations and merges Google OAuth, encryption, and Hermes volume settings without wiping existing secrets.
